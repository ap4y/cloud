...
- [[https://gitlab.com/ap4y/cloud/raw/master/screenshot2.png][Gallery Grid]]
- [[https://gitlab.com/ap4y/cloud/raw/master/screenshot1.png][Gallery Preview]]
- [[https://gitlab.com/ap4y/cloud/raw/master/screenshot3.png][Files Preview]]
- [[https://gitlab.com/ap4y/cloud/raw/master/screenshot4.png][Files Grid]]
...
#+BEGIN_SRC shell
go get -u gitlab.com/ap4y/cloud/cmd/cloud
#+END_SRC
...
*Cloud* uses ~json~ config files to setup authentication and necessary paths. [[https://gitlab.com/ap4y/cloud/blob/master/config.example.json][Sample config]]:
